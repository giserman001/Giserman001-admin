<template>
  <div class="MakeChart">
    <ExamplesModal :open="showExamplesModal" @selected="onSelectedChart" @closeModal="onCloseModal" />
    <Container
    ...
    />
    <Setting :selectedChartId="selectedChartId" :open="showSettings" @save="onSaveSetting" @close="showSettings = false"></Setting>
  </div>
</template>
