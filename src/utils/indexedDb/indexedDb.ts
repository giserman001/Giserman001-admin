...
export interface DbIndex { key: string, option?: IDBIndexParameters }
...
export class IndexedDb {
  ...
  constructor({ dbName, version, tables }: IIndexedDb) {
    this.dbName = dbName
  ...
  public static getInstance(dbOptions?: IIndexedDb): IndexedDb {
    if (IndexedDb._instance === null && dbOptions)
      IndexedDb._instance = new IndexedDb(dbOptions)
