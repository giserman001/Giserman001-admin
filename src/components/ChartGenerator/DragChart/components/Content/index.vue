<template>
  <div class="Content">
    <Draggable animation="300" :list="chartList" group="DragChart" ghostClass="ghost" chosenClass="chosen" item-key="fieldId" class="Draggable">
      <template #item="{ element, index }">
        <Warpper @click="onClick(index, element)" :selected="selectedId === element.fieldId" :item="element" :currentIndex="index" @remove="onDelChart">
