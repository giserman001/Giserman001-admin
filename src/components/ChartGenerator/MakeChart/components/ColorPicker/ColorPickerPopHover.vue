<template>
  <a-popover :title="$t('自定义颜色')" overlayClassName="themeColorCustomColor" placement="bottomRight">
    <template #content>
      <ColorPicker @change="onChangeColor" format="hex" disableHistory disableAlpha disableColorInput />
    </template>
