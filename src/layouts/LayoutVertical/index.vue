<template>
  <a-layout ly-h-full>
    <div ly-flex="~ col" :style="{ width: collapsed ? '80px' : '256px' }" ly-overflow-hidden
      ly-transition="[width] duration-[0.3s] ease">
      <div ly-w-full ly-px="[15px]" ly-flex ly-items-center ly-border-r="1px solid #e4e7ed" ly-h="[64px]"
        ly-bg="[#fff]">
      ...
      <a-layout-sider width="256px" :style="siderStyle" :theme="slideTheme" class="ly-flex-1!" v-model:collapsed="collapsed">
        <Menu :collapsed="collapsed" :menu="menuList" :theme="slideTheme" :mode="mode"></Menu>
      </a-layout-sider>
    </div>
    <a-layout>
